...
SITES = {
    "San Francisco": {
        ...
        "addr":           "San Francisco HQ",
        "building":       "San Francisco HQ",
        "street_address": "525 market street, san francisco, california",
    },
    "New York": {
        "code":           "nyc",
        "octet":          12,
        ...
        "lng":            -74.0060,
        "region":         "Americas",
        "display_name":   "Branch-NYC",
        "addr":           "Branch-NYC",
        "building":       "Branch-NYC",
        "street_address": "200 park avenue, new york, new york",
    },
    "London": {
        "code":           "lon",
        "octet":          13,
        ...
        "lng":            -0.1278,
        "region":         "EMEA",
        "display_name":   "Branch-London",
        "addr":           "Branch-London",
        "building":       "Branch-London",
        "street_address": "1 canada square, london, england",
    },
}
...
for loc, rows in rows_by_site.items():
    ...
    networks.append({
        ...
        "timeZone":      cfg["tz"],
        "tags":          [cfg["region"], code],  # region first so UAI picks it up for Region field
    ...
    for r in site_dev_rows:
        ...
        device = {
            ...
            "lanIp":            lan_ip,
            "tags":             [cfg["region"], code],
            "lat":              cfg["lat"],
            "lng":              cfg["lng"],
            "address":          cfg["street_address"],  # full street address — UAI parses city from this
